...
const Privacy = () => {
    return (
        <section className="address-wrap-new get-in-touch privacy">
            <div className="hdr">
                <span className='created'>Current as of 20 Jan 2022</span>
                <h2>Privacy Policy</h2>
                <span className="tagline">Your privacy is important to us at Untitled. We respect your privacy regarding any information we may collect from you across our website.</span>
            </div>
            <div className="swich-wrap">
                <span className="tag active">human-friendly</span>
                <span className="tag">legal nonsense</span>
            </div>
            <div className="para">
